...
> 🆕 **Update terbaru — Batch 315 (Lanjutan audit Batch 314: `verticalScroll` ke 3 sheet lagi):** `EqualizerSheet.kt`, `RingtoneCutterSheet.kt`, `VisualizerSheet.kt` sekarang bisa discroll (`verticalScroll`) — 3 dari 5 sheet yang diaudit Batch 314 karena punya pola sama (`Column` tanpa jaring pengaman scroll, berisiko baris bawah ke-clip diam-diam di layar pendek/font besar). 2 sisanya (`UpdateCheckSheet.kt`, `BackupRestoreSheet.kt`, konten pendek & risiko rendah) diantrekan Batch 316.
...
- Diantrekan Batch 316: `verticalScroll` (fix pola sama Batch 314/315) belum diterapkan ke `UpdateCheckSheet.kt`, `BackupRestoreSheet.kt` — 2 sisa hasil audit "pola tab serupa" Batch 314 (konten pendek, risiko rendah); `EqualizerSheet.kt`, `RingtoneCutterSheet.kt`, `VisualizerSheet.kt` sudah dibereskan Batch 315
