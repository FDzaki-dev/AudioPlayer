...
> 🆕 **Update terbaru — Batch 312 (Rapikan sheet "Kontrol Lanjutan": kelompokkan per-kegunaan):** 9 baris menu (Antrean, Lirik, Sleep Timer, Kecepatan, Equalizer, Repeat A-B & Bookmark, Visualizer, Edit Info, Potong Nada Dering) yang sebelumnya flat tanpa jeda sekarang dikelompokkan jadi 3 seksi ala grouped-list iOS: **Pemutaran** (Antrean/Sleep Timer/Kecepatan/Repeat A-B), **Audio** (Equalizer/Visualizer/Peredam Volume), **Lagu** (Lirik/Edit Info/Potong Nada Dering) — tiap seksi punya label kecil + divider pemisah.
