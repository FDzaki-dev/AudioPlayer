...
> - **Tab minimized kliping tepi layar (Batch 455/457 di 50%, ditune Batch 458 ke ~30% timbul)**:
>   feedback user atas hasil Batch 454 — tab 48dp yang tadinya berhenti flush TAPI 100% kelihatan
>   di tepi sekarang sebagian lebarnya sengaja didorong melewati batas layar
>   (`snapMinimizedToNearestEdge()`, reuse `FLAG_LAYOUT_NO_LIMITS` yang sudah ada sejak Batch 100),
>   sisa yang kelihatan jadi "mini trigger" yang masih bisa di-tap. Batch 458: `EDGE_CLIP_FRACTION`
>   70% (sembunyi) — bagian TIMBUL/kelihatan turun ke ~30%, lebih ngumpet dari Batch 455/457
>   (50/50). *(Batch 456 sempat 30% sembunyi/70% timbul — itu SALAH ARAH, direvert Batch 457.)*
>   Berlaku di semua jalur snap (manual/auto-minimize/restart/rotasi); SELAGI masih di-drag tab
>   tetap 100% kelihatan seperti biasa, clip cuma muncul setelah dilepas & diam di tepi. Belum
>   dikonfirmasi device fisik (Batch 453-458, satu alur idle yang sama).
