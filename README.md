...
> - **Tab minimized kliping tepi layar (Batch 455-456)**: feedback user atas hasil Batch 454 —
>   tab 48dp yang tadinya berhenti flush TAPI 100% kelihatan di tepi sekarang sebagian lebarnya
>   sengaja didorong melewati batas layar (`snapMinimizedToNearestEdge()`, reuse
>   `FLAG_LAYOUT_NO_LIMITS` yang sudah ada sejak Batch 100), sisa yang kelihatan jadi "mini
>   trigger" yang masih bisa di-tap. Batch 455 awalnya clip 50% (dianggap user "agak timbul" —
>   bagian tersembunyi terlalu besar); **Batch 456 dikecilkan ke 30%** (`EDGE_CLIP_FRACTION`,
>   ~70% tab tetap kelihatan). Berlaku di semua jalur snap (manual/auto-minimize/restart/rotasi);
>   SELAGI masih di-drag tab tetap 100% kelihatan seperti biasa, clip cuma muncul setelah dilepas
>   & diam di tepi. Belum dikonfirmasi device fisik (Batch 453-456, satu alur idle yang sama).
