...
- **4 tema**: keluarga utama gaya Apple (ikuti sistem, terang, gelap — palet iOS system color, sudut membulat generous) plus satu identitas custom, **Matte Noir**, yang sengaja dibuat berkebalikan: hitam matte hangat (bukan hitam/putih ekstrem ala Apple), aksen tembaga (bukan biru), judul bertipe serif (bukan sans khas SF Pro), sudut nyaris kotak (bukan membulat) — kesan hardware premium yang dikerjakan tangan, bukan permukaan native OS. Matte Noir statis (tidak ikut mode terang/gelap sistem, selalu gelap). **Kedalaman visual**: cahaya ambient tembaga radial di latar layar, bar navigasi & mini player terangkat dengan bayangan bertinta tembaga, trim logam di tepi tiap sheet — bukan sekadar ganti warna datar.
