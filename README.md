...
- **Scroll & overscroll ala iOS** (Batch 364, diperluas Batch 367, pegas balik dipercepat Batch 368): menarik list lewat batas atas/bawah sekarang rubber-band (konten ikut tertarik dengan tahanan yang makin kuat, lalu pegas balik sigap — termasuk saat jari dilepas pelan-pelan tanpa sentakan, bukan cuma saat fling) alih-alih glow instan bawaan Android — berlaku **otomatis di seluruh app**, dipasang sekali di root tema. Kurva fling (momentum setelah jari dilepas) juga dibuat meluncur lebih panjang & mulus meniru UIScrollView, sejauh ini sudah dipasang di tab **Lagu** Perpustakaan (Batch 364) + **Beranda**, dialog **Tambah ke Playlist**, dan **Antrean Putar** (Batch 367); layar lain masih pakai kurva fling bawaan Android sampai giliran masing-masing (lihat "Belum selesai / dalam pengerjaan")
