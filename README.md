...
>   `windowManager.currentWindowMetrics` dari `resources.displayMetrics` — fix bubble gagal
>   konsisten mentok ke ujung layar saat HP mode landscape. Belum dikonfirmasi device fisik.
