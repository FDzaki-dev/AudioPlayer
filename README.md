...
> - Fix label tab bawah terpotong/oversized + drag langsung di tab bar (Batch 442) belum
>   dikonfirmasi user di device asli — khususnya label 3 tab tidak terpotong di font-scale
>   aksesibilitas besar, dan drag jari lintas tab bar (termasuk lintas >1 batas tab) berpindah
...
- **Ikon tab bawah ikut berwarna aksen real-time saat digeser** (Batch 440): sebelumnya (Batch 438/439) cuma pill kaca di belakang ikon yang bertransisi warna, ikonnya sendiri diam di warna default. Sekarang ikon & pill bergerak sebagai 1 aksen warna yang sama, mengikuti persentase geser jari secara langsung (bukan cuma snap setelah tab berpindah) — meniru transisi warna kontinu ala tab bar iOS Jam/Clock. Skeu tetap dikecualikan (identitasnya solid, bukan kaca)
