...
> - Drag langsung di tab bar (Batch 442, disempurnakan Batch 444/445) belum dikonfirmasi user di
>   device asli — khususnya: label 3 tab tidak terpotong di font-scale aksesibilitas besar; drag
...
>   selama drag (Batch 445, sebelumnya masih terasa tertinggal dari jari — Batch 444); tahanan
>   visual halus di ujung kolom Beranda/Pengaturan (Batch 444); dan transisi mulus TANPA lompatan
>   visual persis saat jari dilepas (handoff drag→settle, Batch 445).
