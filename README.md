...
> - **Tab minimized kliping setengah di tepi layar (Batch 455)**: feedback user atas hasil Batch
>   454 — tab 48dp yang tadinya berhenti flush TAPI 100% kelihatan di tepi sekarang SETENGAH
>   lebarnya sengaja didorong melewati batas layar (`snapMinimizedToNearestEdge()`, reuse
>   `FLAG_LAYOUT_NO_LIMITS` yang sudah ada sejak Batch 100), sisa setengah jadi "mini trigger" yang
>   masih bisa di-tap. Berlaku di semua jalur snap (manual/auto-minimize/restart/rotasi); SELAGI
>   masih di-drag tab tetap 100% kelihatan seperti biasa, half-clip cuma muncul setelah dilepas &
>   diam di tepi. Belum dikonfirmasi device fisik (Batch 453-455, satu alur idle yang sama).
