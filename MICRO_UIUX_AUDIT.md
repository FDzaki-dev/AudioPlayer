...
| 1 | Strings & Wording Consistency | 🟡 **Berlanjut (Batch 142-143)**. Batch 142: wording undo-hide disamakan (`"Batalkan"`→`"Urungkan"`). Batch 143: audit "Batal" vs "Tutup" (17 titik) — **0 bug, pola sudah konsisten by-design** (Batal=ada aksi tertunda dibatalkan, Tutup=dialog info-only). Pending: kapitalisasi/tanda baca title dialog, hasil cek formal "Hapus" (22 titik, beda konteks). |
