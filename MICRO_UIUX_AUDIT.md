...
| 3 | Typography Hierarchy | 🟡 **Berlanjut (Batch 149, 154, 159, 160)**. 149: title bottom sheet (1 gap fix). 154: body/label song-row (1 gap fix). 159: field-label caption (1 gap fix). 160: badge/kicker/value-readout (13 titik, 0 bug — konsisten/beda-konteks-sengaja). Seluruh 24 titik `typography.label*` app-wide tuntas diaudit. Pending: line-height (belum diaudit sama sekali), cakupan penuh truncation/ellipsis (sebagian Batch 37, belum formal kategori #3). |
