...
| 6-14 | Now Playing s/d Component Consistency | 🟡 **Berlanjut (Batch 169-170)**. Now Playing 2/11: alignment artwork/title/artist/controls — 0 bug (169). Spacing antar playback controls — **1 bug fix (170)**: Row 5 tombol tanpa fillMaxWidth/horizontalArrangement (cluster rapat) → `.fillMaxWidth()` + `Arrangement.SpaceEvenly`. |
